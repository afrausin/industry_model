...
PROJECT_ROOT = Path(__file__).parent.parent  # macro/
...
def run_scrapers(sources: Optional[List[str]] = None, force: bool = False) -> Dict[str, bool]:
    ...
    from data.ingest.scrapers.fed_scraper import FederalReserveScraper
    from data.ingest.scrapers.atlanta_fed_scraper import AtlantaFedScraper
    from data.ingest.scrapers.fred_scraper import FREDScraper
    from data.ingest.scrapers.ny_fed_scraper import NYFedScraper
    from data.ingest.scrapers.cbo_scraper import CBOScraper
...
def run_fmp_update() -> Dict[str, int]:
    ...
    FMP_DIR = PROJECT_ROOT / "data" / "ingest" / "fmp" / "exploration_results"
