"""
database - Point-In-Time Data Storage and Access
=================================================

This module provides a unified SQLite database for storing and querying
macro economic data with full point-in-time (PIT) support.

Usage:
    from database import PITDatabase, PITDataLoader
